...
// [v4.0] Render to specific context
void CRenderEngine::RenderImage(ID2D1DeviceContext* targetContext, ID2D1Bitmap* bitmap, const D2D1_RECT_F& destRect) {
    if (!targetContext || !bitmap) return;
    
    // Use consistent interpolation
