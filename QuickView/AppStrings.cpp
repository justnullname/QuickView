...
const wchar_t *Settings_Option_IntentRelative = nullptr;
const wchar_t *Settings_Option_IntentPerceptual = nullptr;
...
struct EN {
  ...
  static constexpr const wchar_t *Settings_Option_IntentRelative = L"Relative Colorimetric";
  static constexpr const wchar_t *Settings_Option_IntentPerceptual = L"Perceptual";
...
struct CN {
  ...
  static constexpr const wchar_t *Settings_Option_IntentRelative = L"相对色度 (准确优先)";
  static constexpr const wchar_t *Settings_Option_IntentPerceptual = L"感知意图 (感知优先)";
...
struct TW {
  ...
  static constexpr const wchar_t *Settings_Option_IntentRelative = L"相對色度 (準確優先)";
  static constexpr const wchar_t *Settings_Option_IntentPerceptual = L"感知意圖 (感知優先)";
...
struct JA {
  ...
  static constexpr const wchar_t *Settings_Option_IntentRelative = L"相対的な色域を維持 (正確優先)";
  static constexpr const wchar_t *Settings_Option_IntentPerceptual = L"知覚的 (見た目優先)";
...
struct RU {
  ...
  static constexpr const wchar_t *Settings_Label_CmsIntent = L"Намерение рендеринга";
  static constexpr const wchar_t *Settings_Option_IntentRelative = L"Относительная колориметрическая (Точность)";
  static constexpr const wchar_t *Settings_Option_IntentPerceptual = L"Перцепционная (Восприятие)";
...
struct DE {
  ...
  static constexpr const wchar_t *Settings_Label_CmsIntent = L"Rendering-Intent";
  static constexpr const wchar_t *Settings_Option_IntentRelative = L"Relativ farbmetrisch";
  static constexpr const wchar_t *Settings_Option_IntentPerceptual = L"Perzeptiv";
...
struct ES {
  ...
  static constexpr const wchar_t *Settings_Label_CmsIntent = L"Propósito de representación";
  static constexpr const wchar_t *Settings_Option_IntentRelative = L"Colorimétrico relativo";
  static constexpr const wchar_t *Settings_Option_IntentPerceptual = L"Perceptual";
...
template <typename T> void ApplyT() {
  ...
  Settings_Option_IntentRelative = T::Settings_Option_IntentRelative;
  Settings_Option_IntentPerceptual = T::Settings_Option_IntentPerceptual;
