...
struct CN {
  ...
  static constexpr const wchar_t *OSD_ZoomPrefix =
      L"缩放: ";
  ...
  static constexpr const wchar_t *Context_Exit =
      L"退出\tMButton/Esc";
...
struct TW {
  ...
  static constexpr const wchar_t *Help_Action_SmartZoom = L"智能缩放 (100% / 適應窗口)";
...
struct JA {
  ...
  static constexpr const wchar_t *Settings_Label_DisableEdgeNavInCompare = L"比較モードで無効にする";
  ...
  static constexpr const wchar_t *Help_Desc_Edit = L"Edit";
  static constexpr const wchar_t *Help_Header_Tips = L"Tips & Glossary";
  static constexpr const wchar_t *Help_Tip_ContextScope = L"注: ショートカットとメニューは現在のプロセスのみ。設定は永続。";
  static constexpr const wchar_t *Help_Tip_Rotation = L"回転: '端を適応'はデータ損失なし(境界を微調整)。'非可逆'は再変換。";
  static constexpr const wchar_t *Help_Tip_VideoWall = L"ビデオウォール (Ctrl+F11): 全モニター表示。終了はダブルクリック。";
  static constexpr const wchar_t *Help_Tip_DesignerMode = L"デザイナー: 固定、リサイズ、ズーム。ウィンドウをドラッグして調整。";
  static constexpr const wchar_t *Help_Tip_Raw = L"RAW: デフォルトはプレビュー。クリックでフルデコード。";
  static constexpr const wchar_t *Help_Tip_JpegQ =
  ...
  static constexpr const wchar_t *HUD_Tip_Sharp_Desc = L"エッジ定義 (ラプラシアン分散)";
  static constexpr const wchar_t *HUD_Tip_Sharp_High = L"鮮明なエッジ、高精細";
  static constexpr const wchar_t *HUD_Tip_Sharp_Low = L"ソフトフォーカスまたはブレ";
  static constexpr const wchar_t *HUD_Tip_Sharp_Ref = L"> 500 is very sharp";
  static constexpr const wchar_t *HUD_Tip_Ent_Desc = L"情報密度 (シャノン・エントロピー)";
  static constexpr const wchar_t *HUD_Tip_Ent_High = L"複雑なテクスチャまたはノイズ";
  static constexpr const wchar_t *HUD_Tip_Ent_Low = L"平坦な領域または低詳細";
  static constexpr const wchar_t *HUD_Tip_Ent_Ref = L"7.0-8.0 is high detail";
  static constexpr const wchar_t *HUD_Tip_BPP_Desc = L"ビット/ピクセル (圧縮効率)";
  static constexpr const wchar_t *HUD_Tip_BPP_High = L"低効率 (データをより多く保持)";
  static constexpr const wchar_t *HUD_Tip_BPP_Low = L"高効率 (高圧縮率)";
  ...
  static constexpr const wchar_t *Settings_Label_TextColor =
      L"テキスト色";
...
struct RU {
  ...
  static constexpr const wchar_t *OSD_HEICCodecMissing = L"Невозможно декодировать HEIC - установите расширение HEVC";
  ...
  static constexpr const wchar_t *Settings_Label_SpanDisplays = L"Распределять по мониторам (видеостена)";
  ...
  static constexpr const wchar_t *Settings_Text_Copyright = L"Copyright © 2025 - %s Vivor Loong (@justnullname)";
  static constexpr const wchar_t *Settings_Text_License = L"Лицензия GNU GPL v3.0";
  ...
  static constexpr const wchar_t *Toolbar_Tooltip_CompareSyncZoomOn = L"Синхр. масштаба: ДА";
  static constexpr const wchar_t *Toolbar_Tooltip_CompareSyncZoomOff = L"Синхр. масштаба: НЕТ";
  static constexpr const wchar_t *Toolbar_Tooltip_CompareSyncPanOn = L"Синхр. панорамирования: ДА";
  static constexpr const wchar_t *Toolbar_Tooltip_CompareSyncPanOff = L"Синхр. панорамирования: НЕТ";
  ...
  static constexpr const wchar_t *OSD_PrintInstruction = L"Печать: Нажмите Ctrl+P в открытом приложении";
  ...
  static constexpr const wchar_t *Context_ActualSize = L"Настоящий размер (100%)\t1 / Z";
  ...
  static constexpr const wchar_t *Context_LockWindow = L"Заблокировать размер окна";
  ...
  static constexpr const wchar_t *Context_SpanDisplays = L"Распределять по мониторам (видеостена)\tCtrl+F11";
  ...
  static constexpr const wchar_t *Settings_Label_RoundedCorners = L"Скруглённые углы";
  ...
  static constexpr const wchar_t *Settings_Label_RememberLastWindowSize = L"Запоминать последний размер окна";
  static constexpr const wchar_t *Settings_Label_UpscaleSmallImagesWhenLocked = L"Адаптировать мелкие изображения";
  static constexpr const wchar_t *Settings_Label_EnableSmoothScaling = L"Плавное масштабирование окна (ГП)";
  static constexpr const wchar_t *Settings_Label_ExifMode = L"Режим панели EXIF";
  static constexpr const wchar_t *Settings_Label_ToolbarInfoDefault = L"Информация в панели по умолчанию";
  static constexpr const wchar_t *Settings_Label_OpenFullScreenMode = L"Полноэкранный режим при открытии";
  static constexpr const wchar_t *Settings_Label_FullScreenZoomMode = L"Масштаб в полноэкранном режиме";
  ...
  static constexpr const wchar_t *Settings_Label_InvertButtons = L"Инвертировать действие боковых кнопок";
  static constexpr const wchar_t *Settings_Label_ZoomModeIn = L"Увеличить";
  static constexpr const wchar_t *Settings_Label_ZoomModeOut = L"Уменьшить";
  ...
  static constexpr const wchar_t *Settings_Label_EdgeNavClick = L"Навигация при щелчке по краям";
  static constexpr const wchar_t *Settings_Label_DisableEdgeNavInCompare = L"Отключить в режиме сравнения";
  ...
  static constexpr const wchar_t *Settings_Option_CmsIntentPerceptual = L"Перцептивный";
  static constexpr const wchar_t *Settings_Action_CheckUpdates = L"Проверить наличие новой версии";
  ...
  static constexpr const wchar_t *Settings_Option_Linear = L"Линейный (простое сглаживание)";
  static constexpr const wchar_t *Settings_Option_Nearest = L"По соседним (макс. резкость)";
  ...
  static constexpr const wchar_t *HUD_Tip_Sharp_Desc = L"Определение границ (Лапласова дисперсия)";
  static constexpr const wchar_t *HUD_Tip_Sharp_High = L"Чёткие края, высокая детализация";
  static constexpr const wchar_t *HUD_Tip_Sharp_Low = L"Мягкий фокус или размытие в движении";
  static constexpr const wchar_t *HUD_Tip_Sharp_Ref = L"> 500 - очень резко";
  static constexpr const wchar_t *HUD_Tip_Ent_Desc = L"Плотность информации (энтропия Шеннона)";
  static constexpr const wchar_t *HUD_Tip_Ent_High = L"Сложные текстуры или высокий уровень шума";
  ...
  static constexpr const wchar_t *HUD_Tip_BPP_Desc = L"Бит на пиксел (эффективность сжатия)";
  static constexpr const wchar_t *HUD_Tip_BPP_High = L"Низкая эффективность (сохраняется больше данных)";
  static constexpr const wchar_t *HUD_Tip_BPP_Low = L"Высокая эффективность (более плотное сжатие)";
  static constexpr const wchar_t *HUD_Tip_BPP_Ref = L"24.0 (Raw RGB), ~2.0-3.0 (High JPEG), ~0.5-1.5 (WebP/AVIF)";
...
struct DE {
  ...
  static constexpr const wchar_t *Settings_Header_PoweredBy = L"Powered by";
  static constexpr const wchar_t *Settings_Text_Copyright = L"Copyright © 2025 - %s Vivor Loong (@justnullname)";
  static constexpr const wchar_t *Settings_Text_License = L"Lizenziert unter GNU GPL v3.0";
  ...
  static constexpr const wchar_t *Settings_Label_DisableEdgeNavInCompare = L"Im Vergleichsmodus deaktivieren";
  ...
  static constexpr const wchar_t *Help_Desc_Edit = L"Edit";
  static constexpr const wchar_t *Help_Header_Tips = L"Tips & Glossary";
  static constexpr const wchar_t *Help_Tip_ContextScope = L"Hinweis: Shortcuts gelten nur für aktuellen Prozess.";
  static constexpr const wchar_t *Help_Tip_Rotation =
  ...
  static constexpr const wchar_t *HUD_Tip_Sharp_Low = L"Weichzeichner oder Unschärfe";
  static constexpr const wchar_t *HUD_Tip_Sharp_Ref = L"> 500 is very sharp";
...
struct ES {
  ...
  static constexpr const wchar_t *Settings_Text_Copyright = L"Copyright © 2025 - %s Vivor Loong (@justnullname)";
  static constexpr const wchar_t *Settings_Text_License = L"Licenciado bajo GNU GPL v3.0";
  static constexpr const wchar_t *Message_SaveErrorTitle = L"Error";
  ...
  static constexpr const wchar_t *Settings_Label_DisableEdgeNavInCompare = L"Desactivar en modo de comparación";
  ...
  static constexpr const wchar_t *Help_Desc_Edit = L"Edit";
  static constexpr const wchar_t *Help_Header_Tips = L"Tips & Glossary";
  static constexpr const wchar_t *Help_Tip_ContextScope = L"Nota: Atajos solo afectan al proceso actual.";
  static constexpr const wchar_t *Help_Tip_Rotation =
      L"Rotation: 'Edge Adapted' means minor cropping to fit block boundaries "
      L"(lossless data). 'Lossy' means full re-encoding.";
  static constexpr const wchar_t *Help_Tip_VideoWall =
  ...
  static constexpr const wchar_t *HUD_Tip_Sharp_Desc = L"Edge definition (Laplacian Variance)";
  static constexpr const wchar_t *HUD_Tip_Sharp_High = L"Crisp edges, high detail";
  static constexpr const wchar_t *HUD_Tip_Sharp_Low = L"Desenfoque o movimiento";
  static constexpr const wchar_t *HUD_Tip_Sharp_Ref = L"> 500 is very sharp";
  static constexpr const wchar_t *HUD_Tip_Ent_Desc = L"Information density (Shannon Entropy)";
  static constexpr const wchar_t *HUD_Tip_Ent_High = L"Complex textures or high noise";
  static constexpr const wchar_t *HUD_Tip_Ent_Low = L"Flat areas or low detail";
