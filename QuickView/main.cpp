        ...
        GamutWarningOverlayState overlay;
                ...
                if (g_config.GamutWarningEnabled && g_renderEngine && evt.rawFrame && evt.rawFrame->format != QuickView::PixelFormat::SVG_XML) {
                    ...
                    if (g_runtime.EnableSoftProofing && !g_runtime.SoftProofProfilePath.empty()) {
                        ...
                        const QuickView::DisplayColorState displayState = g_renderEngine->GetDisplayColorState();
                    ...
                    g_renderEngine->TriggerGamutWarningAnalysisMain(*evt.rawFrame, &finalTransform, targetPeak);
                }
