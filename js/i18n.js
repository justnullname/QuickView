const translations = {
    "en": {
        ...
        "card.memory.title": "Memory Revolution",
        "card.memory.desc": "Integrated Microsoft <strong>Mimalloc</strong>. Replaces global new/delete for 10-20% faster allocation and zero fragmentation.",
        "card.render.title": "Render Pipeline",
        "card.render.desc": "<strong>DXGI Waitable Swap Chain</strong> for ultra-low latency. <strong>C++23 Coroutines</strong> for 'Fire-and-Forget' async loading.",
        ...
        "feat.mag": "Magnetic Time Lock",
        "feat.mag.desc": "Zooming through 100% automatically locks the view for 400ms, providing a tactile 'notch' feel.",
        ...
        "feat.grid.desc": "Auto-aligning virtual grid displaying EXIF, GPS (Map Link), and real-time sparse-sampled RGB Luma Histograms.",
        "feat.info": "Deep Format Info",
        "feat.info.desc": "Detects Chroma Subsampling (4:2:0), estimates JPEG/WebP Q-Factor, and identifies color spaces (sRGB/P3).",
        "feat.osd": "Smart OSD",
    ...
    "zh-CN": {
        ...
        "card.memory.title": "内存管理革命",
        "card.memory.desc": "集成微软 <strong>Mimalloc</strong>。全局替换 new/delete，内存分配性能提升 10-20%，零碎片。",
        "card.render.title": "渲染管线升级",
        "card.render.desc": "<strong>DXGI Waitable Swap Chain</strong> 物理级压榨延迟。<strong>C++23 协程</strong> 实现“Fire-and-Forget”异步加载。",
        "memory.text": "实测验证：高性能，低开销。",
        "sec1.stack": "全明星解码栈",
        "sec2.title": "2. 原生与极简",
        "sec2.desc": "符合“无边框、沉浸式”的设计目标。",
        "feat.mag": "磁性时间锁",
        "feat.mag.desc": "缩放经过 100% 时自动吸附并暂时锁定滚轮（400ms），提供精密仪器的段落感。",
        "feat.resize": "智能缩放",
        ...
        "feat.grid": "终极元数据面板",
        "feat.grid.desc": "虚拟网格自动对齐。解析 EXIF、GPS (支持点击打开地图)、直方图 (稀疏采样秒出)。",
        "feat.info": "深度格式信息",
        "feat.info.desc": "检测色度采样 (4:2:0)，估算 JPEG/WebP Q值，识别色彩空间 (sRGB/P3)。",
        "feat.osd": "智能 OSD",
