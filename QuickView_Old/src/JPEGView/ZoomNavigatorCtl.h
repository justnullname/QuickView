...
{
public:
	CZoomNavigatorCtl(CMainDlg* pMainDlg, CPanel* pNavigationPanel);
	...
	void OnPaint(CDC& paintDC, CRectF visRectZoomNavigator, const CImageProcessingParams* pImageProcParams, 
